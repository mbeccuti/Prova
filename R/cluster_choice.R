...
#' @return The matrixes in which are stored the AIC and Bic values for each model, and a list with the output of .
#' @examples
#' add(1, 1)
#' add(10, 11)
#' add(3,47)
...
Custer_choice<-function(database,K,H)
{


  path <-"C:/Users/Simone/Desktop/UNIVERSITA'/Progetto Francesca/Essenziale/1864_no_P7.csv"
  Nmice<-24
