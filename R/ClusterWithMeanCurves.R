...
#' @param model String model name, it can assume one of these four values: FCM, Malthus, Gompertz and Logistic.
#' @return List containing the cluster mean curves plot for the model choosen, the k growth curves plots divided
#'        depending on the cluster and a lis of informations about the model clustered. The information list stores
#'        the mean cluster.
#' @examples
#'
#'
